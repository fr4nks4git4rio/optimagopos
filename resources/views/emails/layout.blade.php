...
<head>
    ...
    <style>
        ...
        table.table th table.table>thead>th table.table>thead>tr>th {
        ...
        .button-primary {
            ...
            border-bottom: 8px solid #3f8ceb;
            border-left: 18px solid #3f8ceb;
            border-right: 18px solid #3f8ceb;
            border-top: 8px solid #3f8ceb;
        }
