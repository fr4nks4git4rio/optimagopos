@section('title', $notaCredito->id ? __('site.invoices.save_credit_note.edit_credit_note') :
    __('site.invoices.save_credit_note.create_credit_note'))
    ...
    <div class="container-fluid py-4 position-relative">
        ...
        <div
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-1 small">
                        <li class="breadcrumb-item"><a href="{{ route('admin.pre-facturas.index') }}"
                                class="text-decoration-none">{{ __('site.invoices.save_credit_note.pre_invoices') }}</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">
                            {{ $notaCredito->id ? __('site.invoices.save_credit_note.edit') : __('site.invoices.save_credit_note.new') }}
                        </li>
                    </ol>
                </nav>
            ...
            <div class="d-flex flex-wrap gap-2">
                <a href="{{ route('admin.pre-facturas.index') }}" class="btn btn-outline-secondary px-3">
                    <i class="bi bi-arrow-left me-1"></i> {{ __('site.invoices.save_credit_note.back') }}
                </a>
                <button wire:click="saveNotaCredito()" class="btn btn-primary px-4 fw-bold">
                    <i class="bi bi-download me-1"></i> {{ __('site.invoices.save_credit_note.save') }}
                </button>
                @if ($notaCredito->exists)
                    ...
                    <button wire:click="timbrarFactura({{ $notaCredito->id }})" class="btn btn-success px-4 fw-bold">
                        <i class="bi bi-lightning-charge-fill me-1"></i> {{ __('site.common.stamp') }}
                    </button>
                @endif
            </div>
        </div>
        ...
        <div wire:init="loadInitialData" class="row g-4">
            ...
            <div class="col-lg-6">
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-light py-3 border-0 d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 fw-bold text-secondary text-uppercase small tracking-wide">
                            <i class="bi bi-person-check-fill text-primary me-2"></i>1.
                            {{ __('site.invoices.save_credit_note.client_selection') }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-4">
                            <x-select2-ajax label="{{ __('site.invoices.save_credit_note.client') }}"
                        ...
                        <div class="row g-3">
                            <div class="col-sm-4">
                                <x-select2-ajax label="{{ __('site.invoices.save_credit_note.serie') }}"
                                    placeholder="{{ __('site.common.select') }}" class="form-control"
                            ...
                            <div class="col-sm-4">
                                <label
                                    class="text-muted fw-bold small">{{ __('site.invoices.save_credit_note.relation_type') }}</label>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-light py-3 border-0">
                        <h5 class="mb-0 fw-bold text-secondary text-uppercase small tracking-wide">
                            <i class="bi bi-credit-card-2-front-fill text-primary me-2"></i>2.
                            {{ __('site.invoices.save_credit_note.payment_tax_details') }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-3 mb-3">
                            <div class="col-sm-6">
                                <x-select2-ajax label="{{ __('site.invoices.save_credit_note.cfdi') }}"
                                    placeholder="{{ __('site.common.select') }}..." class="form-control"
                                    url="{{ route('cfdis.load-cfdis') }}" model="cfdi_id" />
                            </div>
                            <div class="col-sm-6">
                                <label
                                    class="text-muted fw-bold small">{{ __('site.invoices.save_credit_note.receipt_type') }}</label>
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <x-select2-ajax label="{{ __('site.invoices.save_credit_note.payment_method') }}"
                                    placeholder="{{ __('site.common.select') }}..." class="form-control"
                                    url="{{ route('metodos-pagos.load-metodos-pagos') }}" model="metodo_pago_id" />
                            </div>
                            <div class="col-sm-6">
                                <x-select2-ajax label="{{ __('site.invoices.save_credit_note.payment_form') }}"
                                    placeholder="{{ __('site.common.select') }}..." class="form-control"
                        ...
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-sm-4">
                                <label
                                    class="text-muted fw-bold small">{{ __('site.invoices.save_credit_note.exchange_rate') }}</label>
                            ...
                            <div class="col-sm-4">
                                <label
                                    class="text-primary fw-bold small">{{ __('site.invoices.save_credit_note.payment_import') }}</label>
                                <div class="input-group">
            ...
            <div class="col-lg-6">
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-light py-3 border-0">
                        <h5 class="mb-0 fw-bold text-secondary text-uppercase small tracking-wide">
                            <i class="bi bi-file-earmark-check-fill text-primary me-2"></i>3.
                            {{ __('site.invoices.save_credit_note.associate_availables_invoices') }}
                        </h5>
                    </div>
                                ...
                                <thead class="bg-light position-sticky top-0 shadow-sm" style="z-index: 1;">
                                    <tr>
                                        ...
                                        <th class="py-3 text-muted small">
                                            {{ __('site.invoices.save_credit_note.internal_folio') }}</th>
                                        <th class="py-3 text-muted small text-center">
                                            {{ __('site.invoices.save_credit_note.currency') }}</th>
                                        <th class="py-3 text-muted small text-end pe-3">
                                            {{ __('site.invoices.save_credit_note.certification_date') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @if (!$this->client_is_selected)
                                        <tr>
                                            <td colspan="4" class="text-center py-5 text-muted">
                                                ...
                                                {{ __('site.invoices.save_credit_note.no_client_selected') }}
                                            </td>
                                        </tr>
                                    @else
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="4" class="text-center py-5 text-muted">
                                                    ...
                                                    {{ __('site.invoices.save_credit_note.no_pending_invoices') }}
                                                </td>
                                            </tr>
                                        @endif
                                    @endif
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-light py-3 border-0">
                        <h5 class="mb-0 fw-bold text-secondary text-uppercase small tracking-wide">
                            <i class="bi bi-list-stars text-primary me-2"></i>4.
                            {{ __('site.invoices.save_credit_note.concepts') }}
                        </h5>
                    </div>
                    <div class="card-body p-0">
                            ...
                            <table class="table align-middle mb-0">
                                <thead class="bg-light">
                                    <tr class="text-muted small">
                                        <th class="ps-3 py-2">{{ __('site.invoices.save_credit_note.cant_code_unit') }}
                                        </th>
                                        <th class="py-2" style="width: 45%;">
                                            {{ __('site.invoices.save_credit_note.description') }}</th>
                                        <th class="text-end py-2">{{ __('site.invoices.save_credit_note.unitary_price') }}
                                        </th>
                                        <th class="text-end pe-3 py-2">{{ __('site.invoices.save_credit_note.import') }}
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    @if ($factura_conceptos && count($factura_conceptos) > 0)
                                        ...
                                        <tr class="bg-light-subtle">
                                            ...
                                            <td class="text-end text-muted py-1 small">
                                                {{ __('site.invoices.save_credit_note.subtotal') }}:</td>
                                        ...
                                        <tr class="bg-light-subtle">
                                            <td colspan="2" class="border-0"></td>
                                            <td class="text-end text-muted py-1 small">
                                                {{ __('site.invoices.save_credit_note.iva') }} (16%):</td>
                                            <td class="text-end pe-3 text-secondary fw-semibold py-1">
                                        ...
                                        <tr class="bg-light border-top">
                                            ...
                                            <td class="text-end fw-bold text-dark py-2">
                                                {{ __('site.invoices.save_credit_note.total') }}:</td>
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="4" class="text-center py-4 text-muted small">
                                                {{ __('site.invoices.save_credit_note.no_concepts_added') }}
                                            </td>
                                        </tr>
                                    @endif
                                </tbody>
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        @if ($asociar_facturas)
                            <div
                                ...
                                <label class="text-primary fw-bold small mb-2"><i class="bi bi-link-45deg"></i>
                                    {{ __('site.invoices.save_credit_note.stamped_available_invoices') }}</label>
                                <table class="table table-striped table-sm align-middle mb-0">
                                    <thead class="table-light">
                                        <tr class="small text-muted">
                                            <th>Sel.</th>
                                            <th>{{ __('site.invoices.save_credit_note.issue_date') }}</th>
                                            <th>{{ __('site.invoices.save_credit_note.internal_folio') }}</th>
                                            <th>{{ __('site.invoices.save_credit_note.type') }}</th>
                                            <th>{{ __('site.invoices.save_credit_note.status') }}</th>
                                            <th class="text-end">{{ __('site.invoices.save_credit_note.subtotal') }}</th>
                                            <th class="text-end pe-2">{{ __('site.invoices.save_credit_note.total') }}
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                        ...
                        <div>
                            <x-textarea label="{{ __('site.invoices.save_credit_note.comments') }}" model="comentarios"
                                placeholder="{{ __('site.invoices.save_credit_note.comments_placeholder') }}..."
                                rows="3" />
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content shadow-lg border-0">
                    <div class="modal-header bg-dark text-white">
                        <h5 class="modal-title fw-bold"><i class="bi bi-file-earmark-pdf me-2 text-danger"></i>PDF</h5>
