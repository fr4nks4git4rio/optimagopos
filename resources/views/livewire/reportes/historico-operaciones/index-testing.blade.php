@section('title', __('site.reports.operations_history.testing_title'))
        ...
        <div class="col-11 mb-3">
            <div class="row">
                <div class="col-md-2 col-6">
                    <x-input label="{{ __('site.reports.operations_history.start_date') }}" type="date"
                        :debounce="200" :lazy="true" model="fecha_inicio" />
                </div>
                <div class="col-md-2 col-6">
                    <x-input label="{{ __('site.reports.operations_history.end_date') }}" type="date"
                        :debounce="200" :lazy="true" model="fecha_fin" />
                </div>
                <div class="col-md-4 col-12">
                    <x-select2-multiple class="form-control"
                        label="{{ __('site.reports.operations_history.branches') }}" :lazy="true"
                        model="sucursales" :options="$sucursalesDisponibles" />
                </div>
                <div class="col-md-4 col-12">
                    <x-select2-multiple class="form-control"
                        label="{{ __('site.reports.operations_history.terminals') }}" :dynamic="true"
                        :lazy="true" model="terminales" :options="$terminalesDisponibles" />
                </div>
                <div class="input-group">
                    <span class="input-group-text"><x-icon name="search" /></span>
                    <input type="search" placeholder="{{ __('site.reports.operations_history.search') }}"
