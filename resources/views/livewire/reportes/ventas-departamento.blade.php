@section('title', __('site.reports.sales_by_department.title'))
...
<div wire:init="init">
    ...
    <div class="row justify-content-between">
        <div class="row mb-1 col-md-10">
            <div class="col-sm-2">
                <x-input label="{{ __('site.reports.sales_by_department.start_date') }}" type="date" :lazy="true"
                    model="fechaInicio" />
            </div>
            <div class="col-sm-2">
                <x-input label="{{ __('site.reports.sales_by_department.end_date') }}" type="date" :lazy="true"
                    model="fechaFin" />
            </div>
            <div class="col-sm-8">
                <x-select2-multiple label="{{ __('site.reports.sales_by_department.branches') }}"
        ...
        <div class="mb-1 col-md-2 text-end">
            @can('reportsSalesByDepartment-print')
            ...
            @endcan
            @can('reportsSalesByDepartment-export')
            ...
            <tbody>
                @forelse($records as $sucursal_id => $sucursalData)
                    ...
                    <tr class="table-success fw-bold">
                        <td class="text-end" colspan="2">{{ __('site.reports.sales_by_department.total') }}
            ...
            @if (count($records) > 0)
                <tfoot>
                    <tr class="table-dark fw-bold">
                        <td colspan="2" class="text-end">{{ __('site.reports.sales_by_department.grand_total') }}</td>
    ...
    <div class="modal fade" id="pdf-ventas-departamento">
