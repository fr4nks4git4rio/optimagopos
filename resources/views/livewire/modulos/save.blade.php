<x-modal form-action="save">
    <x-slot:title>
        <span class="text-capitalize">{{ $modulo->exists ? __('site.modules.save.edit_module') : __('site.modules.save.create_module') }}</span>
    </x-slot:title>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-3">
                                    <label class="form-label fw-bold text-capitalize">{{ __('site.modules.save.icon') }}</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    <label class="form-label fw-bold text-capitalize">{{ __('site.modules.save.base_cost') }}</label>
                                    <div class="input-group">
                ...
                <div class="col-md-5">
                    <div class="card shadow-sm border-0 sticky-top" style="top: 20px;">
                        <div class="card-header bg-light py-3">
                            <h6 class="mb-0 text-muted text-uppercase fw-bold"
                                style="font-size: 0.8rem; letter-spacing: 1px;">{{ __('site.modules.save.preview') }}</h6>
                        </div>
                        <div class="card-body p-4 text-center">
                            ...
                            <h4 class="fw-bold text-dark text-truncate text-capitalize">{{ $nombre ? $nombre : __('site.modules.save.module_name_placeholder') }}</h4>
                            <p class="text-muted small mb-4" style="min-height: 40px;">
                                {{ $descripcion ? $descripcion : __('site.modules.save.module_description_placeholder') }}
                            </p>

                            <div class="row g-2 border-top pt-3">
                                <div class="col-6 border-end">
                                    <small class="text-muted d-block text-capitalize">{{ __('site.modules.save.functions') }}</small>
                                    <span class="fs-5 fw-bold text-dark">{{ $cant_funciones ?: 0 }}</span>
                                </div>
                                <div class="col-6">
                                    <small class="text-muted d-block text-capitalize">{{ __('site.modules.save.base_cost') }}</small>
                                    <span
