                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input id="email" type="email"
                                ...
                                name="email" wire:model.live="email" required autocomplete="email" autofocus
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input id="password" type="password"
                                ...
                                name="password" wire:model.live="password" required autocomplete="new-password"
                                placeholder="••••••••">
                        </div>
                        @error('password')
                            <span class="invalid-feedback d-block fw-medium mt-2" role="alert">{{ $message }}</span>
