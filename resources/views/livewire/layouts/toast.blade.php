<div x-data="{
    ...
    show_closable: false,
    can_close: true,
    timeout: $wire.entangle('timeout').live,
    closeProcess() {
        this.can_close = true;
        setTimeout(() => {
    ...
    <div class="{{ $alertTypeClasses[$alertType] }} pb-0 pt-2">
        ...
        <a x-show="show_closable" @click="show=false" href="javascript:void(0)"
            class="position-absolute fs-5 text-decoration-none" style="top: 0; right: 4px"><x-icon
                name="x-circle"></x-icon></a>
    </div>
</div>
