    ...
    <tbody>
        @forelse($records as $sucursal_id => $sucursalData)
            ...
            <tr>
                ...
                <td style="font-weight: bold !important; text-align: end;">
    ...
    @if (count($records) > 0)
        <tfoot>
            <tr>
                ...
                <td style="text-align: end; font-weight: bold;">{{ number_format($grandTotal['ventas_importe'], 2) }}</td>
                <td style="text-align: center; font-weight: bold;">{{ $grandTotal['ventas_cant'] }}</td>
                <td style="text-align: end; font-weight: bold;">{{ number_format($grandTotal['correcciones_importe'], 2) }}
                </td>
