<table>
        ...
        <tr>
            <td colspan="4">
                ...
                @if (!empty($sucursalesSeleccionadas))
                    &nbsp;|&nbsp;
                    {{ __('site.reports.total_sales_by_operator.branches') }}: &nbsp;
        ...
        @forelse($records as $sucursal_id => $sucursalData)
            ...
            <tr>
                <td style="font-weight: bold !important; text-align: right;">
                    {{ __('site.reports.total_sales_by_department.total') }} {{ $sucursalData['sucursal'] }}</td>
                <td style="font-weight: bold !important; text-align: right;">
    ...
    @if (count($records) > 0)
        <tfoot>
            <tr>
                <td colspan="2" style="text-align: right; font-weight: bold;">{{ __('site.reports.total_sales_by_department.grand_total') }}</td>
