...
return [
    ...
    | utilisés par la classe de validation. Certaines de ces règles possèdent
    | plusieurs versions, comme les règles de taille. N'hésitez pas à ajuster
    ...
    */
    ...
    'array' => 'Le champ :attribute doit être un tableau (array).',
    ...
    'encoding' => 'Le champ :attribute doit avoir un encodage :encoding.',
    ...
    'missing_unless' => 'Le champ :attribute ne doit pas être présent à moins que :other soit :value.',
    ...
    'password' => [
        ...
        'uncompromised' => 'La valeur saisie pour :attribute est apparue dans une fuite de données. Veuillez choisir une valeur différente pour :attribute.',
    ],
    ...
    */
    ...
    'custom' => [
        'nombre-atributo' => [
            'nombre-regla' => 'message-personnalisé',
        ],
    ...
    | à rendre nos messages plus explicites.
    |
    */
    ...
    'attributes' => [
        ...
        'cliente_id' => 'client',
        'sucursal_id' => 'succursale',
        'paquete_id' => 'forfait',
        'fecha_inicio_operaciones' => 'date de début des opérations',
        'fecha_inicio_pagos' => 'date du prochain prélèvement',
        'periodicidad_pagos' => 'période de facturation',
        'moneda_sucursal' => 'devise de la succursale',
        'objeto_impuesto_id' => 'objet fiscal',
        'clave_prod_serv_id' => 'code produit service',
        'clave_unidad_id' => 'code d\'unité'
    ],
