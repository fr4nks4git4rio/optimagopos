...
class Configuraciones extends Modal
{
    ...
    public function save($key)
    {
        if ($key == 'moneda_sucursal') {
            if (!$this->{$key}) {
                $this->dispatch('show-toast', __('site.common.form_with_errors'), 'danger');
        ...
        $this->dispatch('show-toast', __('site.branches.configs.configs_updated'));
    ...
    public function saveTasa()
    {
        ...
        $this->loadTiposCambio();
        $this->dispatch('show-toast', __('site.branches.configs.exchange_rate_saved'));
        $this->dispatch('$refresh');
    }
    ...
    public function editTasa($id)
    {
        ...
        if (!$tipo_cambio || $tipo_cambio->sucursal_id != $this->sucursal->id) {
            $this->dispatch('show-toast', __('site.branches.configs.exchange_rate_not_found'), 'danger');
            return;
        }
        $this->tipo_cambio = [
            'id' => $tipo_cambio->id,
