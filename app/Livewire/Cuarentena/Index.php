...
namespace App\Livewire\Cuarentena;
...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        $total = $records->count();
        $currentItems  = $records->forPage($currentPage, $this->perPage);

        $records = new LengthAwarePaginator($currentItems, $total, $this->perPage, $currentPage, ['path' => LengthAwarePaginator::resolveCurrentPath()]);
    ...
    public function changeIsVK($id)
    {
        ...
        $this->dispatch('show-toast', 'Registro modificado.', 'success');
