...
class SaveFacturaConcepto extends Component
{
    ...
    public function nuevoConcepto($scope = null)
    {
        ...
        $this->dispatch('set-data-clave_prod_serv_id', ['data' => [], 'term' => '', 'value' => null]);
    }
    ...
    public function editarConcepto($index, $concepto, $scope = null)
    {
        ...
        if ($this->clave_prod_serv_id) {
            $this->dispatch('set-data-clave_prod_serv_id', ['data' => [(array)ClaveProdServ::find($this->clave_prod_serv_id)->only(['id', 'text'])], 'term' => '', 'value' => $this->clave_prod_serv_id]);
        } else {
            $this->dispatch('set-data-clave_prod_serv_id', ['data' => [], 'term' => '', 'value' => null]);
        }
    }
    ...
    public function guardar()
    {
        ...
        if ($this->index === null)
            $this->dispatch('concepto-creado', $data)->to($this->scope);
        else
            $this->dispatch('concepto-modificado', $this->index, $data)->to($this->scope);
