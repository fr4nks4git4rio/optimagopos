...
class IndexAlmacen extends Component
{
    ...
    public function mount()
    {
        ...
        $this->sorts = [
            ...
            __('site.invoices.index_storage.type'),
    ...
    public function showPdf($id)
    {
        ...
        $this->dispatch('show-sub-modal', 'pdf-index-almacen');
    }
    ...
    public function descargarXml($id)
    {
        ...
        if ($factura->direccion_xml && Storage::disk('public')->exists($factura->direccion_xml))
            ...
            $this->dispatch('show-toast', __('site.invoices.index_storage.no_xml_file_found'), 'danger');
    }
