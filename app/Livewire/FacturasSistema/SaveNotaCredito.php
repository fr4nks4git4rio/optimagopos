...
class SaveNotaCredito extends Component
{
    ...
    public function loadInitialData()
    {
        if ($this->notaCredito->exists) {
            ...
            // $this->serie_id = 6;
            // $this->dispatch('set-data-serie_id', ['data' => [Serie::find(6)->only('id', 'text')], 'term' => '', 'value' => 6]);
        }
    }
    ...
    public function saveNotaCredito()
    {
        ...
        $this->dispatch('show-toast', __('site.invoices.save_credit_note.credit_note_saved'));
