...
class Index extends Component
{
    ...
    protected $queryString = ['search', 'perPage', 'page', 'order', 'sort', 'filter'];
    ...
    public function render()
    {
        ...
        $usuarios = new LengthAwarePaginator($currentItems, $total, $this->perPage, $currentPage, ['path' => LengthAwarePaginator::resolveCurrentPath()]);
