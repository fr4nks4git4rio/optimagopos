...
class IndexTesting extends Component
{
    use WithPagination;
    public $fecha_inicio;
    public $fecha_fin;
    ...
    public function render()
    {
        ...
        return view('livewire.reportes.historico-operaciones.index-testing', [
            'tickets' => $tickets,
    ...
    {
        if (user()->cannot('reportsTestingOperationsHistory-viewAny')) {
    ...
    public function query()
    {
        ...
        foreach ($tickets as $ticket) {
            ...
            if (user()->hasAnyRole(['Admin', 'Manager']) && $ticket['empleado'] == 'NEXORA_160706_TESTING')
                continue;
