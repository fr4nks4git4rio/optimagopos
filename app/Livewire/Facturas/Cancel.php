...
class Cancel extends Modal
{
    ...
    {
        $type = __('site.common.invoice');
        if ($this->factura->es_complemento)
            $type = __('site.common.complement');
        else if ($this->factura->es_nota_credito)
            $type = __('site.common.credit_note');

        return __('site.invoices.cancel.invoice_to_cancel', ['type' => $type, 'folio' => $this->factura->folio_interno]);
    }
