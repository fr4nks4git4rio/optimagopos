...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        $subs = new LengthAwarePaginator($currentItems, $total, $this->perPage, $currentPage, ['path' => LengthAwarePaginator::resolveCurrentPath()]);
    ...
    public function descargarPdf($id)
    {
        ...
        $this->dispatch('show-sub-modal', 'pdf-suscripciones');
    }
